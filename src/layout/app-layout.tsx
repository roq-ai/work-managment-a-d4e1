...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'project-manager', 'client', 'administrator', 'team-member'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Projects', path: '/projects', entity: 'project', service: AccessServiceEnum.PROJECT, icon: FiFolder },
    { name: 'Teams', path: '/teams', entity: 'team', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    { name: 'Tickets', path: '/tickets', entity: 'ticket', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
    {
      name: 'Time Entries',
      path: '/time-entries',
      entity: 'time_entry',

...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`work managment app`}</title>

        <meta
          name="description"
          content="Work Management App - Streamlining your work, one task at a time. Track, manage, and create tickets, while also managing your projects. Empower your employees, satisfy your clients."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1647365368632-90028b7faa23?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3b3JrJTIwbWFuYWdlbWVudHxlbnwwfHx8fDE2OTUyOTQ5NzB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@mike_cho?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Mike Cho`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Work Management App - Streamlining your work, one task at a time. Track, manage, and create tickets, while also managing your projects. Empower your employees, satisfy your clients.`}
            </Text>
            <Box

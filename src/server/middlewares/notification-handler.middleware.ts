...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'project_create.create': {
    roles: ['business-owner', 'project-manager', 'client', 'administrator', 'team-member'],
    key: 'project_id',
    tenantPath: [],
    userPath: [],
  },
  ...
  'invoice_generate.create': {
    roles: ['business-owner', 'project-manager', 'client', 'administrator'],
    key: 'invoice_id',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'project-manager', 'client', 'administrator', 'team-member'];
